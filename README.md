...
| `/rerank/*` | tei-reranker :80 | cross-encoder reranking for RAG (Cohere-compatible `/rerank` endpoint). Same TEI image, different model — CPU-only, no GPU stake. Default model `bge-reranker-v2-m3`. |
